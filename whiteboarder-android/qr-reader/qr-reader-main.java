package whiteboarder.whiteboarder;      // altered (com.example.jaredgorton.qr_reader.MainActivity)
...
public class qr-reader-main extends AppCompatActivity implements ZXingScannerView.ResultHandler  {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(qr-reader-main.this)
                .setMessage(message)
    ...
    public void handleResult(Result rawResult) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mScannerView.resumeCameraPreview(qr-reader-main.this);
            }
        });
